...
@pytest.fixture
def data_list_for_investment_bank():
    return [
        {
            "Дата операции": "03.01.2018",
            "Дата платежа": "04.01.2018",
            "Номер карты": "*7197",
            "Статус": "OK",
            "Сумма операции": -73.06,
...
@pytest.fixture
def data_list_for_searching_with_phone_number():
    return [
        {
...
@pytest.fixture
def data_with_physical_persons():
    return [
        {
            "Дата операции": "2018-01-03",
            "Дата платежа": "04.01.2018",
